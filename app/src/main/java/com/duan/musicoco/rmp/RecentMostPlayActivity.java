...
public class RecentMostPlayActivity extends RootActivity implements
    ...
    private int rmp_first_three_song_path = 1000;
    ...
    private void prepareDataForFirstThree() {
        ...
        while (data.size() >= c) {
            ...
            // 用于点击事件构造歌曲
            holders[a].image.setTag(rmp_first_three_song_path, d.path);
    ...
    public void firstThreeClick(View view) {
        String path = (String) view.getTag(rmp_first_three_song_path);
